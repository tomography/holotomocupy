...
tifffile.imwrite(f'/data/holo/data{imsize}_{code_position}mm_{code_size}um_{ncodes}_{use_prb}_{use_codes}.tiff',data[0])
tifffile.imwrite(f'/data/holo/rec{imsize}_{code_position}mm_{code_size}um_{ncodes}_{use_prb}_{use_codes}.tiff',np.angle(rec))
np.save(f'res_numpy/pnsr{imsize}_{code_position}mm_{code_size}um_{ncodes}_prb{use_prb}_code{use_codes}',psnr)
np.save(f'res_numpy/ssim{imsize}_{code_position}mm_{code_size}um_{ncodes}_prb{use_prb}_code{use_codes}',ssim)
